public class Calculator {
    ...
    /*
     ...
     the value of secondNumber field.
     • Method named setFirstNumber with one parameter of type double, it needs to
     set the value of the firstNumber field.

     • Method named setSecondNumber with one parameter of type double, it needs
     to set the value of the secondNumberfield.
     ...
     result of dividing the field values of firstNumber by the secondNumber. In case
     the value of secondNumber is 0 then return 0.
     ...
     In total, you must write 8 methods.
     Do not add the main method to the class Calculator.
    */
